...
<body class="styleBD">
	...
	<br/><br/><br/>
	<a class="btn btn-primary" href="formIncidencia.php?rol=<?php echo $rol; ?>" style="width: 240px; height: 40px" target="_blank"> ALTA DE NUEVA INCIDENCIA </a>
	<br/><br/><br/>
	<a class="btn btn-primary" style="width: 260px; height: 40px" href="consultaIncidenciaDia.php?rol=<?php echo $rol ?>&&f=<?php echo $fechaGet ?>" target="_blank">CONSULTAR INCIDENCIAS DEL DÍA</a>
	<br/><br/><br/>
	<a class="btn btn-primary" href="consultaIncidenciaDia.php?rol=<?php echo $rol; ?>" style="width: 230px; height: 40px" target="_blank"> INCIDENCIAS POR RESOLVER </a>
	<br/><br/><br/>
	<hr />
	<form action="consultaIncidenciasFechas.php" method = "post" target="_blank">
		<strong><span>Incidencias por Fechas de Alta</span>
		<br/><br/>
		<span>DEL&nbsp; </span>
		...
		<input id="btIncidFechas" class="btn-primary" type="submit" value = "INCIDENCIAS" style="height: 50px; width: 200px" />
		<br/>
	</form>
