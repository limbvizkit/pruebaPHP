...
<?php
	...
	if (isset($_GET['word']))
	{
		...
		if($areaFin == '15' || $areaFin == '38'){
			...
			$sect->writeText('Reporte de incidencias del día y pendientes por resolver', $font, new PHPRtfLite_ParFormat());
		}
		$sect->writeText('<br/>');
...
'.$nombreUsr.'                      T.E. José Alfredo Salgado M.             Lic. Ezequiel Vargas Franco                                             
		...
		<table id="simple">
		 <thead>
          ...
          <?php if($mostrarOpc){ ?>
			...
			<th class="auto-style2">&nbsp;MOVIMIENTOS&nbsp;</th>
