	...
	<body class="bg-blue">
		<div>
			<h1 style="color: aliceblue">
				<img alt="logoHD" height="100" width="108" src="../img/logoNew2.jpg" /> IMAGENOLOGÍA </h1>
		</div>
		<div class="body">
			<!-- tabs -->
			<div class="sky-tabs sky-tabs-pos-top-left sky-tabs-anim-flip sky-tabs-response-to-icons">
				...
				<label for="sky-tab2"><span><span><i class="fa fa-exclamation-circle"></i>SOLICITUDES A IMAGENOLOGÍA</span></span></label>
				...
				<ul>
					...
					<li class="sky-tab-content-2">
						<div class="typography">
							<h1>SOLICITUD A IMAGENOLOGÍA</h1>
							...
							<p>
								...
								onClick="window.open('../medicoHospital/consultaSolImagen.php?rol=<?php echo $rol ?>&exp=<?php echo $expediente_pac ?>&folio=<?php echo $folio_pac ?>', '_blank').focus()"/>
							</p>
						</div>
					</li>
		...
		&nbsp;&nbsp;<input type="image" src="img/regresa.png" value="REGRESAR" onclick=location.href="index.php?rol=<?php echo $rol ?>&permisos=<?php echo $permisos ?>" height="90" width="160"/>
</body>
</html>