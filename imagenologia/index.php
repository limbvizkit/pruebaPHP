...
<title>VISTA IMAGENOLOGÍA</title>
...
<body class="styleBD" >
	...
	<p class="auto-style7" ><strong>BIENVENIDO(A) AL MÓDULO DE IMAGENOLOGÍA<br/></strong>
	<br>
	<!--span> <strong>FAVOR DE DE SELECCIONAR UNA DE LAS SIGUIENTES OPCIÓNES</strong> </span></p-->
	<br class="auto-style6"/>
	<div class="auto-style1" >
	<span class="auto-style3" align="center"> SOLICITUDES DE ESTUDIOS:</span>
	<br/>
	<br/>
		<p class="auto-style5" > <input class="btn btn-primary" type="button" value="SOLICITUDES" onClick=window.open('listaImg.php?rol=<?php echo $rol ?>','_black') style="width: 147px; height: 44px" /></p>
	<br/>
	<br/>
...
<!----------------------Primera Opcion BUSCAR POR NUM DE EXPEDIENTE---------------------------------------------------------->
	...
	<br/>
	<br/>
		<p class="auto-style5" > <input class="btn btn-primary" type="button" value="IMAGENOLOGÍA" onClick=location.href="tabsAdversoNE.php?rol=<?php echo $rol ?>&permisos=<?php echo $permisos ?>" style="width: 147px; height: 44px" /></p>
	<br/-->
	<hr style="height:10px; background-color: darkcyan">
	<div class="auto-style1" >
		<span class="auto-style3" align="center"> HISTÓRICO DE ESTUDIOS:</span>
	<br/>
	<br/>
	...
	<form action="excel.php" method = "post">
		<br/>
		<strong><span class="auto-style7">EXCEL HISTÓRICO DE ESTUDIOS
		<br/></span> <br/>
