							...
							<div class="8u 12u(narrower)">
								...
								<!-- Content -->
									<article id="content">
										<header>
											<h2>VACACIONES</h2>
											<p>Llena el formulario y agenda tus vacaciones.</p>
										</header>
										<a href="rh/vacaciones.php?x=<?php echo $usuario ?>" class="image featured" target="_blank">
											<img src="images/vacaciones2.jpg" alt="" /></a>
								...
								<ul class="actions">
									<li><a href="rh/vacaciones.php?x=<?php echo $usuario ?>" class="button" target="_blank">Formulario Vacaciones</a></li>
									<li><a href="rh/listadoVacaciones.php?x=<?php echo $usuario ?>" class="button" target="_blank">Listado de solicitudes</a></li>
								</ul>
							</div>
								...
								<!-- Sidebar -->
									<section id="sidebar">
										<section>
											...
											<p>COMUNICADOS PARA EL PERSONAL</p>
											<ul class="actions">
												<li><a href="no-sidebar.php?x=<?php echo $usuario ?>" class="button">VER</a></li>
											</ul>
										</section>
										<section>
											...
											<ul class="actions">
												<li><a href="left-sidebar.php?x=<?php echo $usuario ?>" class="button">CONSULTAR</a></li>
											</ul>
										</section>
							</div>
						</div>
						...
						<div class="row features">
							<section class="4u 12u(narrower) feature">								
								<div class="image-wrapper first">
									<a href="#" class="image featured"><img src="images/turno.jpg" alt="" height="205" width="250"/></a>
								</div>
								<header>
								...
								<ul class="actions">
									<li><a href="#" class="button">Formulario Cambio de turno</a></li>
								</ul>
							</section>
							<section class="4u 12u(narrower) feature">
								...
								vel sem sit dolor neque semper magna lorem ipsum.</p>
								<ul class="actions">
									<li><a href="#" class="button">Formulario Cumpleaños</a></li>
								</ul>
							</section>
							<section class="4u 12u(narrower) feature">
								<div class="image-wrapper">
									<a href="#" class="image featured"><img src="images/salida.jpg" alt="" height="205" width="200"/></a>
								</div>
								<header>
								...
								vel sem sit dolor neque semper magna lorem ipsum.</p>
								<ul class="actions">
									<li><a href="#" class="button">Formulario Pase salida </a></li>
								</ul>
							</section>
						</div>
					</div>
