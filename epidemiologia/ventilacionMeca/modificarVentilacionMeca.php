...
<?php
	...
	if (isset($_POST['idVM']))
	{
		...
		$formularioTemp = "<div><label style='color: beige'>Fecha Instalación (*):</label><input type='date' autocomplete='off' class='nombre' name='fechaInst' id='fechaInst' value='$fechaInst'></div>
						...
						<input type='hidden' name='idVM' id='idVM' value='$idVM' >
						<div><input type='submit' value='Guardar' class='boton' name='boton' id='enviarVM'>";
...
<script type="text/javascript">
 ...
 $("#enviarVM").click(function(evento){
        ...
        $.ajax({
            ...
            success: function(data) {
				if(data==1){
					...
					$("#Usuarios").html("");
					$("#Usuarios").load("consultaVentilacionMeca.php", function(){});
