...
<html lang="es">
    <head>
        ...
        <title>CONSULTA Venti Meca</title>
        <!-- Google Font -->
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
			  ...
			  $('#simple').on('click', '#vig', function () {
				...
				$("#div_User").load("modificarVentilacionMeca.php",{idVM:idVM,fechaInst:fechaInst,fechaFin:fechaFin,fecha1:fecha1,fecha2:fecha2,verificador:verificador,nombreInstalo:nombreInstalo,observaciones:observaciones} ,function(){
