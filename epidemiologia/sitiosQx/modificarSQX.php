...
<?php
	...
	if (isset($_POST['idSQ']))
	{
		...
		$formularioTemp = "<div><label style='color: beige'>Fecha Instalación (*):</label><input type='date' autocomplete='off' class='nombre' name='fechaInst' id='fechaInst' value='$fechaInst'></div>
						...
						<input type='hidden' name='idSQ' id='idSQ' value='$idSQ' >
						<div><input type='submit' value='Guardar' class='boton' name='boton' id='enviarSQ'>";
...
<script type="text/javascript">
 ...
 $("#enviarSQ").click(function(evento){
        ...
        $.ajax({
            ...
            success: function(data) {
				if(data==1){
					...
					$("#Usuarios").html("");
					$("#Usuarios").load("consultaSQX.php", function(){});
