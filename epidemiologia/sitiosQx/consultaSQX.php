...
<html lang="es">
    <head>
        ...
        <title>CONSULTA SITIOS QUIRÚRGICOS</title>
        <!-- Google Font -->
						...
						<table id="simple" class="display">
							...
							<tbody>
								...
								<tr id="vig">
									...
									<td id="vigRPBIVig"><?php echo utf8_encode($row['nombInstalo']) ?></td>
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
			  ...
			  $('#simple').on('click', '#vig', function () {
				...
				$("#div_User").load("modificarSQX.php",{idSQ:idSQ,fechaInst:fechaInst,fechaFin:fechaFin,fecha1:fecha1,fecha2:fecha2,verificador:verificador,nombreInstalo:nombreInstalo,observaciones:observaciones} ,function(){
