<?php
	...
	if(isset($_REQUEST['enviar']))
	{
		...
		if (isset($_POST['sondaPac']))
		{
			$sondaPac=$_POST['sondaPac'];
		}
		...
		if (isset($_POST['fijadaPac']))
		{
			$fijadaPac=$_POST['fijadaPac'];
		}
		if (isset($_POST['vejigaPac']))
		{
			$vejigaPac=$_POST['vejigaPac'];
		}
		if (isset($_POST['flujoPac']))
		{
			$flujoPac=$_POST['flujoPac'];
		}
		if (isset($_POST['drenadoPac']))
		{
			$drenadoPac=$_POST['drenadoPac'];
		}
		if (isset($_POST['sitiosPac']))
		{
			$sitiosPac=$_POST['sitiosPac'];
		}
		if (isset($_POST['morbilidadPac']))
		{
			$morbilidadPac=$_POST['morbilidadPac'];
		}
		if (isset($_POST['cuidadosPac']))
		{
			$cuidadosPac=$_POST['cuidadosPac'];
		}
		if (isset($_POST['infeccionPac']))
		{
			$infeccionPac=$_POST['infeccionPac'];
		}
		...
		'$cuidadosPac','$infeccionPac','$observaciones', '$rol')";
			...
			if(!$result0) {
				echo '!<br> ERROR al realizar inserción de Instalacion de Sonda Vesical! <br>';
				echo 'QUERY: '.$queryInsrSv;
			} else {
				echo '<br>!!!! SE GUARDO LA INSTALACION DE SONDA VESICAL CORRECTAMENTE!!!!<br>';
			}
                ...
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1 col-lg-6 col-lg-offset-3 col-md-10 col-md-offset-1">
                    	...
                    	<form role="form" action="" method="post">
                    		<h3>PROGRAMA DE PREVENCIÓN DE INFECCIONES ASOCIADAS A SONDA VESICAL</h3>
                    		<p>PAQUETE BUNDLE PARE PREVENCION DE INFECCIONES POR CATETER URINARIO</p>
							...
							<fieldset>
								...
								<div class="form-group">
                    			    <label>1. VERIFICÓ LA INDICIACION EN EL EXPEDIENTE DE USO DE LA SONDA VESICAL : </label>
									<br>
                                    <label class="radio-inline">
									  <input type="radio" name="sondaPac" value="1" checked="checked"> CUMPLE
									</label>
									<label class="radio-inline">
									  <input type="radio" name="sondaPac" value="0"> NO CUMPLE
									</label>
									<label class="radio-inline">
									  <input type="radio" name="sondaPac" value="NA"> NO APLICA
									</label>									
                                </div>
                    			<div class="form-group">
                    			    <label>2. APLICÓ TÉCNICA ADECUADA DE LAVADO DE MANOS : </label>
									<br>
                                    <label class="radio-inline">
                                ...
                                <div class="form-group">
                    			    <label>3. UTILIZÓ BARRERA MÁXIMA PARA LA INSTALACIÓN : </label>
                                    <br>
                                    <label class="radio-inline">
								...
								<div class="form-group">
                    			    <label>4. VERIFICÓ TÉCNICA APROPIADA PARA LA INSERCIÓN DE LA SONDA VESICAL : </label>
                                    <br>
                                     <label class="radio-inline">
								...
								<div class="form-group">
                    			    <label>5. VERIFICÓ QUE LA SONDA FUERA FIJADA DEACUERDO AL SEXO DEL PACIENTE :</label>
                                    <br>
                                     <label class="radio-inline">
									  <input type="radio" name="fijadaPac" value="1" checked="checked"> CUMPLE
									</label>
									<label class="radio-inline">
									  <input type="radio" name="fijadaPac" value="0"> NO CUMPLE
									</label>
									<label class="radio-inline">
									  <input type="radio" name="fijadaPac" value="NA"> NO APLICA
									</label>									
                                </div>
								<div class="form-group">
                    			    <label>6. VERIFICÓ QUE LA BOLSA RECOLECTORA SE MANTIENE POR DEBAJO DEL NIVEL DE LA VEJIGA : </label>
                                    <br>
                                    <label class="radio-inline">
									  <input type="radio" name="vejigaPac" value="1" checked="checked"> CUMPLE
									</label>
									<label class="radio-inline">
									  <input type="radio" name="vejigaPac" value="0"> NO CUMPLE
									</label>
									<label class="radio-inline">
									  <input type="radio" name="vejigaPac" value="NA"> NO APLICA
									</label>									
                                </div>
								<div class="form-group">
                    			    <label>7. VERIFICÓ QUE SE MANTIENGA UN FLUJO SIN OBSTRUCCION : </label>
                                    <br>
                                    <label class="radio-inline">
									  <input type="radio" name="flujoPac" value="1" checked="checked"> CUMPLE
									</label>
									<label class="radio-inline">
									  <input type="radio" name="flujoPac" value="0"> NO CUMPLE
									</label>
									<label class="radio-inline">
									  <input type="radio" name="flujoPac" value="NA"> NO APLICA
									</label>
                                </div>
								<div class="form-group">
                    			    <label>8. VERIFICÓ QUE SE HA DRENADO PERIODICAMENTE LA BOLSA COLECTORA : </label>
                                    <br>
                                    <label class="radio-inline">
									  <input type="radio" name="drenadoPac" value="1" checked="checked"> CUMPLE
									</label>
									<label class="radio-inline">
									  <input type="radio" name="drenadoPac" value="0"> NO CUMPLE
									</label>
									<label class="radio-inline">
									  <input type="radio" name="drenadoPac" value="NA"> NO APLICA
									</label>									
                                </div>
								<div class="form-group">
                    			    <label>9. VERIFICÓ SI EL PACIENTE TIENE OTROS SITIOS ACTIVOS DE INFECCIÓN : </label>
                                    <br>
                                    <label class="radio-inline">
									  <input type="radio" name="sitiosPac" value="1" checked="checked"> CUMPLE
									</label>
									<label class="radio-inline">
									  <input type="radio" name="sitiosPac" value="0"> NO CUMPLE
									</label>
									<label class="radio-inline">
									  <input type="radio" name="sitiosPac" value="NA"> NO APLICA
									</label>									
                                </div>
								<div class="form-group">
                    			    <label>10. VERIFICÓ SI EL PACIENTE PRESENTA ALGUNA CO-MORBILIDAD (DIABETES,HIPERTENSION,ETC) : </label>
                                    <br>
                                    <label class="radio-inline">
									  <input type="radio" name="morbilidadPac" value="1" checked="checked"> CUMPLE
									</label>
									<label class="radio-inline">
									  <input type="radio" name="morbilidadPac" value="0"> NO CUMPLE
									</label>
									<label class="radio-inline">
									  <input type="radio" name="morbilidadPac" value="NA"> NO APLICA
									</label>									
                                </div>
								<div class="form-group">
                    			    <label>11.  VERIFICÓ QUE EL PACIENTE Y FAMILIAR RECIBIO INFORMACION ACERCA DE LOS CUIDADOS DE LA SONDA URINARIA : </label>
                                    <br>
                                    <label class="radio-inline">
									  <input type="radio" name="cuidadosPac" value="1" checked="checked"> CUMPLE
									</label>
									<label class="radio-inline">
									  <input type="radio" name="cuidadosPac" value="0"> NO CUMPLE
									</label>
									<label class="radio-inline">
									  <input type="radio" name="cuidadosPac" value="NA"> NO APLICA
									</label>									
                                </div>
								<div class="form-group">
                    			    <label>12. IDENTIFICÓ Y REPORTÓ SI EXISTEN SIGNOS QUE SE SOSPECHE INFECCIÓN DE VIAS URINARIAS : </label>
                                    <br>
                                    <label class="radio-inline">
									  <input type="radio" name="infeccionPac" value="1" checked="checked"> CUMPLE
									</label>
									<label class="radio-inline">
									  <input type="radio" name="infeccionPac" value="0"> NO CUMPLE
									</label>
									<label class="radio-inline">
									  <input type="radio" name="infeccionPac" value="NA"> NO APLICA
									</label>									
                                </div>
								<div class="form-group">
