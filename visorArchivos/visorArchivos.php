...
<body class="styleBD" >
  <center>
	...
	<tr>
		...
		<td class="auto-style4"><!--a href="detalleDoc.php?id=<?php echo $row[0] ?>" target="_blank" --> <?php echo utf8_encode($row['nombreDocumento']) ?></td>
	...
	<span class="auto-style2">*Los botones en color amarillo abren el archivo de manera protegida<br>Los verdes permiten descargar<br></span>
			<?php if( $valor == 'medico'){
					echo '<hr/>
					<p class="auto-style5">
					...
					echo '<a class="btn btn-primary" href="../eventosAdversos/index.php?rol='.$rol.'&permisos='.$permisos.'" style="height: 50px; width: 210px; font-size: large;">EVENTOS ADVERSOS</a>';
				}
			?>
			<br />
			<br />
