<?php
	...
	if(isset($_REQUEST['enviar']))
	{
		...
		$queryInsPreopera = "INSERT INTO notapreoperatoriaurg (id,numeroExpediente,folio,servicio,fecha,turno,diagnostico,planQx,tipoIntervencionQx,
								riesgoQx,cuidadosTerapeuticos,pronosticoVida,pronosticoFuncion,nombreMedicoTratante,cedula,usr)
                    		...
                    		<fieldset>
								...
								<div class="form-group">
									...
									<label class="radio-inline">
									  <input type="radio" name="servicio" value="Urgencias" style="width: 30px; height: 30px" checked="checked">&nbsp;&nbsp; Urgencias
									</label>
                                    <label class="radio-inline">
