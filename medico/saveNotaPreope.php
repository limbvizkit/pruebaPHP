...
require_once('../conexion/configMedico.php');
	...
	if(!empty($idNotaPreope)){
		$queryUpdDNotaPreope = "UPDATE notapreoperatoriaurg SET fecha='$fechaFin',servicio='$servicio',turno='$turno',diagnostico='$diagn',
		...
		pronosticoFuncion='$pronosticoFuncion',nombreMedicoTratante='$nomMedico', cedula='$cedula' WHERE id='$idNotaPreope'";
