<?php
	...
	if(isset($_REQUEST['enviar']))
	{
		...
		$queryInsConsenQx = "INSERT INTO consentimientoqxurg (id,numeroExpediente,folio,fechaQx,diagnostico,procedimientos,riesgos,
								beneficios,alternativas,nombreMedicoTratante,cedula,usr)
							VALUES (NULL,'$expediente','$folio','$fecha','$diagnostico','$procedimientos','$riesgos','$beneficios',
									'$alternativas','$nombreMedicoTratante','$cedula','$rol')";
		$result0 = mysqli_query($conexionMedico, $queryInsConsenQx);
		if(!$result0) {
			echo '!<br> ERROR al insertar Consentimiento Quirúrgico! <br>';
			echo 'QUERY: '.$queryInsConsenQx;
		} else {
			echo '<br>!!!! SE GUARDO EL CONSENTIMIENTO QUIRÚRGICO CORRECTAMENTE !!!!<br>';
		}
...
<html lang="es">
    <head>
        ...
        <title>CONSENTIMIENTO INFORMADO QUIRÚRGICO</title>
                ...
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1 col-lg-10 col-lg-offset-13 col-md-10 col-md-offset-1">
                    	...
                    	<form role="form" action="" method="post">
                    		...
                    		<h3>CONSENTIMIENTO INFORMADO QUIRÚRGICO</h3>
                    		<p></p>
