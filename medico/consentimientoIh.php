<?php
	...
	if(isset($_REQUEST['enviar']))
	{
		...
		$queryInsConsenIh = "INSERT INTO consentimientoihurg (id,numeroExpediente,folio,fechaIh,nombreMedicoTratante,cedula,usr)
		...
		if(!$result0) {
			...
			echo '<br>!!!! SE GUARDO EL CONSENTIMIENTO INGRESO HOSPITAL CORRECTAMENTE !!!!<br>';
		}
...
<html lang="es">
    <head>
        ...
        <title>CONSENTIMIENTO INFORMADO PARA INGRESO HOSPITALARIO</title>
                ...
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1 col-lg-10 col-lg-offset-13 col-md-10 col-md-offset-1">
                    	...
                    	<form role="form" action="" method="post">
                    		...
                    		<h3>CONSENTIMIENTO INFORMADO PARA INGRESO HOSPITALARIO</h3>
                    		<p></p>
