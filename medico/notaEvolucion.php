<?php
	...
	if(isset($_REQUEST['enviar']))
	{
		...
		$queryInsUrg = "INSERT INTO notaEvolucion (id,numeroExpediente,folio,fecha,hora,servicio,turno,fc,fr,ta,temp,so,glucosa,peso,talla,evolucion,
			...
			if(!$result0) {
				echo '!<br> ERROR al insertar Nota de Evolucio0n! <br>';
                    ...
                    <div class="col-sm-10 col-sm-offset-1 col-lg-6 col-lg-offset-3 col-md-10 col-md-offset-1">
                    	...
                    	<form role="form" action="" method="post">
                            ...
                            <fieldset>
								...
								<div class="form-group">
                    			    <label>RESULTADOS DE ESTUDIOS AUXILIARES DE DIAGNOSTICO (INCLUIR JUSTIFICACION DE ESTUDIOS SOLICITADOS) : <span>*</span></label>
