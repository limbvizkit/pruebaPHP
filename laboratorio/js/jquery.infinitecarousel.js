		...
		var options = $.extend(defaults, options);
    		...
    		return this.each(function() {
				...
				if(o.displayProgressBar)
				{
					...
					$('#progress'+randID).width(imgWidth).height(5).css('opacity','.85');
				}
				...
				$('#textholder'+randID).width(imgWidth-(correctTHWidth * 2)).height((imgHeight*o.textholderHeight)-(correctTHHeight * 2)).css({'backgroundColor':'#FFF','opacity':'0.80'});
				...
				function showminmax()
				{
						if(!autopilot)
						{
							html = '<img style="position:absolute;top:2px;right:30px;display:none;cursor:pointer" src="js/infiniteCarousel/images/down.png" title="Minimize" alt="minimize" id="min" /><img style="position:absolute;top:1px;right:30px;display:none;cursor:pointer" src="js/infiniteCarousel/images/up.png" title="Maximize" alt="maximize" id="max" />';
				...
				{
					$('#thumbs'+randID+' div').css({'border-color':'#ccc'}).animate({opacity: 0.05},500);
