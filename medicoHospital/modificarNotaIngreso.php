...
<?php
	...
	$formularioNota = "<table>
		...
		<!--tr>
			...
			<td><textarea class='nombre' id='sintomas' name='sintomas' rows='3' cols='70'></textarea></td>
		</tr>
		<tr>
			<td><label style='color: beige'>RESPIRATORIO (*) :</label></td>
			<td><textarea class='nombre' id='respiratorio' name='respiratorio' rows='3' cols='70'></textarea></td>
		</tr>
		<tr>
			<td><label style='color: beige'>MÚSCULO-ESQUELETICO (*) :</label></td>
			<td><textarea class='nombre' id='musculoEsquele' name='musculoEsquele' rows='3' cols='70'></textarea></td>
		</tr>
		<tr>
			<td><label style='color: beige'>DIGESTIVO (*) :</label></td>
			<td><textarea class='nombre' id='digestivo' name='digestivo' rows='3' cols='70'></textarea></td>
		</tr>
		<tr>
			<td><label style='color: beige'>GENITAL (*) :</label></td>
			<td><textarea class='nombre' id='genital' name='genital' rows='3' cols='70'></textarea></td>
		</tr>
		<tr>
			<td><label style='color: beige'>ENDOCRINO (*) :</label></td>
			<td><textarea class='nombre' id='endocrino' name='endocrino' rows='3' cols='70'></textarea></td>
		</tr>
		<tr>
			<td><label style='color: beige'>NERVIOSO (*) :</label></td>
			<td><textarea class='nombre' id='nervioso' name='nervioso' rows='3' cols='70'></textarea></td>
		</tr>
		<tr>
			<td><label style='color: beige'>HEMATOLÓGICO (*) :</label></td>
			<td><textarea class='nombre' id='hematologico' name='hematologico' rows='3' cols='70'></textarea></td>
		</tr>
		<tr>
			<td><label style='color: beige'>PSICOLÓGICOS (*) :</label></td>
			<td><textarea class='nombre' id='psicologico' name='psicologico' rows='3' cols='70'></textarea></td>
		</tr>
		<tr>
			<td><label style='color: beige'>URINARIO (*) :</label></td>
			<td><textarea class='nombre' id='urinario' name='urinario' rows='3' cols='70'></textarea></td>
		</tr>
		<tr>
			<td><label style='color: beige'>CARDIOCIRCULATORIO (*) :</label></td>
			<td><textarea class='nombre' id='cardiocirculatorio' name='cardiocirculatorio' rows='3' cols='70'></textarea></td>
		</tr>
		<tr>
			<td><label style='color: beige'>PIEL Y FANERAS (*) :</label></td>
			<td><textarea class='nombre' id='pielFaneras' name='pielFaneras' rows='3' cols='70'></textarea></td>
		</tr-->
		<tr>
		...
		<!--tr>
			...
			<td><textarea class='nombre' id='criteriosEspecializadas' name='criteriosEspecializadas' rows='3' cols='70'></textarea></td>
		</tr>
		<tr>
			<td><label style='color: beige'>EDUCACIÓN ESPECIAL (*) :</label></td>
			<td><textarea class='nombre' id='educacionEspecial' name='educacionEspecial' rows='3' cols='70'></textarea></td>
		</tr-->
		<tr>
	...
	<br>
	<input type='hidden' name='idNotaIngreso' id='idNotaIngreso' value='$idNotaIngreso' >
        ...
        $.ajax({
            ...
            success: function(data) {
				if(data==1){
					...
					$("#Usuarios").html("");
					$("#Usuarios").load("consultaNotaIngreso.php", function(){});
