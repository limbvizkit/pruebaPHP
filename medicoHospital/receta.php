<?php
	...
	if(isset($_REQUEST['enviar']))
	{
		...
		$queryIndMed = "INSERT INTO receta (id,numeroExpediente,folio,nombrePac,fechaNacimiento,diag,alergias,nombreMed,cedula,universidad,idMedicamentos,
							medicamentos,sal,indicaciones, existencias)
							VALUES (NULL,'$expediente','$folio','$nombre_pac','$fecha_nac_pac','$diagMed','$alergias','$nombMed','$cedulaMed','$univMed',
							'$acturl2','$acturl','$acturl4','$acturl3','$acturl5')";
		
		$result0 = mysqli_query($conexionMedico, $queryIndMed);
		if(!$result0) {
			echo '<br>! ERROR al insertar Datos de Receta Médica! <br>';
			echo 'QUERY: '.$queryIndMed;
		} else {
			echo '<br>!!!! SE GUARDARON LAS DATOS DE LA RECETA MÉDICA CORRECTAMENTE!!!!<br>';
			//echo 'QUERY: '.$queryIndMed;
		}	
                    	...
                    	<form role="form" action="" method="post">
                    		...
                    		<fieldset>
								...
								<div class="form-group">
									...
									<input type="text" name="alergias" id="alergias" class="form-control required" autocomplete="off">
									<br>
									<h3>MEDICAMENTOS</h3>
