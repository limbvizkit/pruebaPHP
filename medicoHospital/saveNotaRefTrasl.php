...
require_once('../conexion/configMedico.php');
	...
	if(!empty($idNotaRefTraslh)){
		...
		peso='$peso',talla='$talla',antecedentesPer='$antecedentesPer',padecimientoAct='$padecimientoAct',expFisica='$expFisica',motivoEnvio='$motivoEnvio',
		impresionDiag='$impresionDiag',terapeuticaEmpl='$terapeuticaEmpl',cedulaMedEntrega='$cedulaMedEntrega',fechaExt='$fechaExt',horaExt='$horaExt',estable='$estable',turnoExt='$turnoExt' 
		WHERE id='$idNotaRefTraslh'";
