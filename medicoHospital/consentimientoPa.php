<?php
	...
	if(isset($_REQUEST['enviar']))
	{
		...
		$queryInsConsenAnest = "INSERT INTO consentimientoanesturg (id,numeroExpediente,folio,fechaQx,diagnostico,riesgos,
								beneficios,alternativas,nombreMedicoTratante,cedula,usr)
							VALUES (NULL,'$expediente','$folio','$fecha','$diagnostico','$riesgos','$beneficios',
									'$alternativas','$nombreMedicoTratante','$cedula','$rol')";
		$result0 = mysqli_query($conexionMedico, $queryInsConsenAnest);
		if(!$result0) {
			echo '!<br> ERROR al insertar Consentimiento de Anestesia! <br>';
			echo 'QUERY: '.$queryInsConsenAnest;
		} else {
			echo '<br>!!!! SE GUARDO EL CONSENTIMIENTO DE ANESTESIA CORRECTAMENTE !!!!<br>';
		}
                ...
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1 col-lg-10 col-lg-offset-13 col-md-10 col-md-offset-1">
                    	...
                    	<form role="form" action="" method="post">
                    		...
                    		<h3>CONSENTIMIENTO INFORMADO PARA PROCEDIMIENTO DE ANESTESIA</h3>
                    		<p></p>
